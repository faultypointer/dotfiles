...
(let* ((bg "#131318")
      ...
      (shadow "#000000")
      (surface "#131318")
      (surface-container "#29292f")
      (surface-container-high "#34343a")
      (surface-container-highest "#29292f")
      (surface-container-low "#1b1b21")
      (surface-container-lowest "#0d0e13")
      (surface-variant "#46464f")
      (tertiary "#e6bad6")
      (tertiary-container "#5e3c54")

      ;; Enhanced dank16 colors for better syntax highlighting
      (dank-red "#ff7295")          ; Bright red
      (dank-red-alt "#ff9fb7")      ; Alternative red
      (dank-green "#7fff95")        ; Vibrant green
      (dank-green-bright "#a5ffb5") ; Bright green
      (dank-yellow "#ffd872")       ; Warm yellow
      (dank-yellow-bright "#ffe6a5") ; Bright yellow
      (dank-blue "#a5acf2")         ; Blue-green
      (dank-magenta "#3d4276")      ; Teal-magenta
      (dank-cyan "#bcc2ff")         ; Bright cyan
      (dank-cyan-bright "#c6cbff") ; Brightest cyan
      (dank-cyan-dark "#d0d4ff")   ; Dark cyan
      (dank-teal "#e0e3ff")        ; Dark teal
      (dank-fg "#eff1ff")           ; Light foreground
      (dank-gray "#999aa5")         ; Gray
      (dank-white "#f8f9ff")       ; White

      ;; Map success colors to green
      (success "#7fff95")
      (on-success "#45263d")
      (success-container "#5e3c54")
      (on-success-container "#ffd7f0")

      ;; Map fixed colors
      (primary-fixed "#dfe0ff")
      (primary-fixed-dim "#bcc2ff")
      (secondary-fixed "#e0e0f9")
      (secondary-fixed-dim "#c4c5dd")
      (tertiary-fixed "#ffd7f0")
      (tertiary-fixed-dim "#e6bad6")
      (on-primary-fixed "#0e154b")
      (on-primary-fixed-variant "#3b4279")
